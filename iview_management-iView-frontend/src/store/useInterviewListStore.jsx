...
const useInterviewStore = create((set) => ({
    ...
    loadInterviews: async () => {
        try {
            const response = await axios.get(`${API_URL}/api/iview/interviews`);
    ...
    addInterview: async (interviewData) => {
        try {
            const response = await axios.post(`${API_URL}/api/iview/create`, interviewData);
            set((state) => ({
    ...
    loadInterview_Id: async (interviewId) => {
        ...
        try {
            const response = await axios.get(`${API_URL}/api/iview/link/${interviewId}`);
    ...
    deleteInterview: async (interviewId) => {
        try {
            await axios.delete(`${API_URL}/api/iview/delete/${interviewId}`);
            set((state) => ({
    ...
    loadCandidateStats: async (interviewId) => {
        set({ isLoading: true, error: null });
        try {
            const response = await axios.get(`${API_URL}/api/candidate/interview/${interviewId}/stats`);
